...
public class PostController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Long> createPost(@HeaderToken(role = {Role.ADMIN, Role.USER}) String token, @RequestParam(required = false) Long teamId,
    ...
    public ResponseEntity<Long> updatePost(@HeaderToken(role = {Role.ADMIN, Role.USER}) String token, @PathVariable Long id,
